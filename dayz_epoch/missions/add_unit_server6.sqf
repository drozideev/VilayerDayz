...
private ["_aiunit","_xpos","_ypos","_unitpos","_aiGroup","_levelnum","_numunits","_rndLOut","_ailoadout","_aispawnpos","_aiwep1","_aiammo1","_aiwep2","_aiammo2"];
    ...
    for [{ x=1 },{ x < _numunits+1 },{ x = x + 1; }] do
    {
        ...
        if (_levelnum==1) then //in_military troops
        {
            ...
            {
                "Ins_Soldier_GL_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"LIEUTENANT"];
            ...
            {
                "Ins_Soldier_GL_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"SERGEANT"];
                _rndLOut=floor(random 3);
                _ailoadout=
                switch (_rndLOut) do
                {
            ...
            {
                "Ins_Soldier_GL_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"CORPORAL"];

...
private ["_aiunit","_xpos","_ypos","_unitpos","_aiGroup","_levelnum","_numunits","_rndLOut","_ailoadout","_aispawnpos","_aiwep1","_aiammo1","_aiwep2","_aiammo2"];
    ...
    for [{ x=1 },{ x < _numunits+1 },{ x = x + 1; }] do
    {
        ...
        if (_levelnum==1) then //in_military troops
        {
            ...
            {
                "GUE_Soldier_CO_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"LIEUTENANT"];
            ...
            {
                "GUE_Commander_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"SERGEANT"];
                _rndLOut=floor(random 4);
                _ailoadout=
                switch (_rndLOut) do
                {
            ...
            {
                "GUE_Soldier_Sniper_DZ" createUnit [_unitpos, LandingParty, "_aiunit=this;",1,"CORPORAL"];

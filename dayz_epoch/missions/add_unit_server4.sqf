...
private ["_aiunit","_xpos","_ypos","_unitpos","_aiGroup","_wppos","_wpradius","_wpnum","_levelnum","_numunits","_rndLOut","_ailoadout","_wp","_aispawnpos","_aiwep1","_aiammo1","_aiwep2","_aiammo2"];
    ...
    for [{ x=1 },{ x < _numunits+1 },{ x = x + 1; }] do
    {
        ...
        if (_levelnum==0) then // in_sityes troops
        {
            ...
            {
                "TK_INS_Soldier_EP1_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"PRIVATE"];
        ...
        if (_levelnum==1) then //in_military troops
        {
            ...
            {
                "TK_INS_Soldier_EP1_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"LIEUTENANT"];
            ...
            {
                "TK_INS_Soldier_EP1_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"SERGEANT"];
                _rndLOut=floor(random 3);
                _ailoadout=
                switch (_rndLOut) do
                {
            ...
            {
                "CZ_Soldier_Sniper_EP1_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"CORPORAL"];

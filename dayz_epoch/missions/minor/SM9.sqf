...
//Mission start
[nil,nil,rTitleText,"Команда фермеров выдвинулась на захват территории!", "PLAIN",6] call RE;
...
[nil,nil,rTitleText,"Нападение фермеров отбито. Собирайте их пожитки!", "PLAIN",6] call RE;

...
//Mission start
[nil,nil,rTitleText,"Грузовик попал в серьезную аварию! Убейте выживших и заберите груз.", "PLAIN",6] call RE;
...
[nil,nil,rTitleText,"Разбитый грузовик зачищен.", "PLAIN",6] call RE;

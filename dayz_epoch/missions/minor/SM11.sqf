...
//Mission start
[nil,nil,rTitleText,"Хаммер попал в серьезную аварию! Убейте выживших и заберите добычу.", "PLAIN",6] call RE;
...
[nil,nil,rTitleText,"Хорошая работа, место аварии зачищено!", "PLAIN",6] call RE;

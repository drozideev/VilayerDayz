...
private ["_aiunit","_xpos","_ypos","_unitpos","_aiGroup","_wppos","_wpradius","_wpnum","_levelnum","_numunits","_rndLOut","_ailoadout","_wp","_aispawnpos","_aiwep1","_aiammo1","_aiwep2","_aiammo2"];
    ...
    for [{ x=1 },{ x < _numunits+1 },{ x = x + 1; }] do
    {
        ...
        if (_levelnum==1) then //in_military troops
        {
            ...
            {
                "GUE_Soldier_CO_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"LIEUTENANT"];
            ...
            {
                "GUE_Commander_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"SERGEANT"];
                _rndLOut=floor(random 4);
                _ailoadout=
                switch (_rndLOut) do
                {
            ...
            {
                "GUE_Soldier_Sniper_DZ" createUnit [_unitpos, _aiGroup, "_aiunit=this;",1,"CORPORAL"];
        ...
        diag_log format ["AIUNIT: Creating Ins_Soldier_GL_DZ by %1 at %2. Result:%3 | Loadout:%4 / Num:%5",player,_unitpos,_aiunit,_ailoadout,_rndLOut];

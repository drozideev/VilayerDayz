...
//Mission start
[nil,nil,rTitleText,"C-130, перевозящий медикаменты, разбился. Бандиты оцепили место катастрофы.", "PLAIN",10] call RE;
...
[nil,nil,rTitleText,"Разбитый самолет отбит у бандитов.", "PLAIN",6] call RE;

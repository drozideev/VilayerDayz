...
//Mission start
[nil,nil,rTitleText,"У бандитов сломался броневик! Отбей его и забери покататься!", "PLAIN",6] call RE;
...
[nil,nil,rTitleText,"Хорошая работа, броневик отбит!", "PLAIN",6] call RE;

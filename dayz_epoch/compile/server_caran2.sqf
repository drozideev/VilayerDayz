	...
	if (_spawnRoll <= _spawnChance) then {
		...
		*/
		...
		for "_x" from 1 to _preWaypoints do {
			...
			_preWaypointPos = [[1100,2460], [1600,2260], [2200,2160], [3100,2260],[3900,2660] ,[4900,2460] ,[6200,2360] ,[8000,3260] ,[8700,2360] ,[11300,3360] ,[12900,3860] ,[13400,5060] ,[13300,6860] ] call BIS_fnc_selectRandom;

...
SAR_sniper_sold_list = ["CZ_Soldier_Sniper_EP1_DZ"]; // the potential classes of the snipers of a soldier group
...
SAR_soldier_band_list = ["Ins_Soldier_GL_DZ", "BanditW1_DZ","GUE_Commander_DZ"]; // the potential classes of the riflemen of a bandit group
...
SAR_soldier_surv_list = ["RU_Policeman_DZ","SurvivorWurban_DZ","Haris_Press_EP1_DZ"]; // the potential classes of the riflemen of a survivor group

...
//baza
_this = createMarker ["SAR_marker_baza", [10295.3,11712.3,294.934]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [30, 30];
SAR_marker_baza = _this;
...
[SAR_marker_DEBUG_devilscastle,1,0,4,"fortify",true] call SAR_AI;
[SAR_marker_baza,3,2,7,"fortify",true] call SAR_AI;

// example war scenario in the northwest. Comment OUT after having had a look at it!
[SAR_marker_DEBUG_veh,1,0,1,"patrol",true] call SAR_AI;
[SAR_marker_DEBUG_veh,2,0,1,"patrol",true] call SAR_AI;
[SAR_marker_DEBUG_veh,3,0,1,"patrol",true] call SAR_AI;
[SAR_marker_DEBUG_veh,3,0,1,"patrol",true] call SAR_AI;

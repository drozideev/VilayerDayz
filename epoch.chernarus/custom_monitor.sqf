...
while {true} do
{
	...
	<t size='1.25' font='Bitstream'align='center' color='#D60000'>DayZ Epoch RU54</t><br/>
	...
	<t size='1.15' font='Bitstream'align='center' color='#5882FA'>Рестарт через %9 минут</t><br/>"
	<t size='1.15' font='Bitstream'align='center' color='#D60000'>vk.com/dayzru54</t><br/>
	<t size='1.15' font='Bitstream'align='center' color='#D60000'>raidcall id7674434</t><br/>,
